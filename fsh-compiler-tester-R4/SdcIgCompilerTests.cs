...
public class SdcIgCompilerTests
{
    ...
    /// </summary>
        private static readonly Dictionary<string, string[]> _fileDependencies = new(StringComparer.OrdinalIgnoreCase)
     {
            ...
            ["demographics.fsh"] = ["AssembleExpectation.fsh", "AssembleExpectationCodes.fsh", "DefinitionExtractExtension.fsh", "DefinitionExtractValueExtension.fsh", "ExtractAllocateIdExtension.fsh", "InitialExpressionExtension.fsh", "ItemPopulationContextExtension.fsh", "OptionalDisplayExtension.fsh", "PerformerTypeExtension.fsh", "QuestionnaireAssembleExpectation.fsh", "QuestionnairePerformerType.fsh", "SDCBaseQuestionnaire.fsh", "SDCQuestionnaireCommon.fsh", "SDCQuestionnaireExtractDefinition.fsh"],
            ...
            ["ihe-sdc-for-SDCQuestionnaireExtractDefinition.fsh"] = ["AssembleExpectation.fsh", "AssembleExpectationCodes.fsh", "DefinitionExtractExtension.fsh", "DefinitionExtractValueExtension.fsh", "ExtractAllocateIdExtension.fsh", "OptionalDisplayExtension.fsh", "PerformerTypeExtension.fsh", "QuestionnaireAssembleExpectation.fsh", "QuestionnairePerformerType.fsh", "SDCBaseQuestionnaire.fsh", "SDCQuestionnaireCommon.fsh", "SDCQuestionnaireExtractDefinition.fsh"],
            ...
            ["SDOHCC-QuestionnaireHungerVitalSign.fsh"] = ["AssembleExpectation.fsh", "AssembleExpectationCodes.fsh", "DefinitionExtractExtension.fsh", "DefinitionExtractValueExtension.fsh", "ExtractAllocateIdExtension.fsh", "OptionalDisplayExtension.fsh", "PerformerTypeExtension.fsh", "QuestionnaireAssembleExpectation.fsh", "QuestionnairePerformerType.fsh", "SDCBaseQuestionnaire.fsh", "SDCQuestionnaireCommon.fsh", "SDCQuestionnaireExtractDefinition.fsh"],
