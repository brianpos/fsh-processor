...
/// Wraps <see cref="FshCompiler"/> with R5-appropriate defaults, supplying the R5
...
public static class R5FshCompiler
{
    ...
    /// and <see cref="CompilerOptions.Inspector"/> defaults to the R5
    ...
    /// <summary>
    /// Compiles all entities across multiple <paramref name="docs"/> to FHIR R5 resources
